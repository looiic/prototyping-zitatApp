...
<div class="m-3">
  ...
  <button type="button" class="btn btn-primary ms-3 mt-4" data-toggle="modal" data-target="#personModal">
    Person hinzufügen
  </button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <input type="text" class="form-control" placeholder="Name" bind:value={newPerson.name}>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Abbrechen</button>
          <button type="button" class="btn btn-primary" on:click={addPerson} data-dismiss="modal">Hinzufügen</button>
        </div>
      </div>
    </div>
  </div>